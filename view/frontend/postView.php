...
<?php ob_start(); ?>
  ...
  <section class="postView-main-container">
    <section class="post-container">
      ...
      <div class="comments-section-tle3">
        ...
        <div class="comments-container"><!-- si l'article n'a pas encore de commentaires ou si les commentaires ne sont pas associés à l'id du post-->
    ...
    <section class="comment-form-container">
      <?php if(!isset($_SESSION['name'])) : ?> <!-- afficher le formulaire pour ajouter un commentaire -->
      	<div class="form">
